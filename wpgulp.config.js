...
module.exports = {
	...
	// Project options.
	projectURL: 'foxtail.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	styleEditorSRC: './assets/sass/editor.scss', // Path to main .scss file.
