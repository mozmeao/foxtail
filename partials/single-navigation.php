...
<div class="ft-c-post-nav">
  <div class="ft-l-container ft-c-post__wrap">
    ...
    <a href="<?php echo get_permalink( $prev_post->ID ); ?>" class="ft-c-post-nav__item ft-c-post-nav__item--left">
    ...
    <a href="<?php echo get_permalink( $next_post->ID ); ?>" class="ft-c-post-nav__item">
      <div class="ft-c-post-nav__item-content">
